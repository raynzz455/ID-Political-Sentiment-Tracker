...
v4_all_in_one.py
================
Self-contained v4 fine-tuning script for Colab.
Combines: hyperparams + finetune + evaluate.
...
Usage in Colab:
  ...
  5. !python v4_all_in_one.py evaluate --task sentiment
"""
...
# H alias for compatibility
H = None  # Will be populated below

# ============================================================================
# SECTION 2: FINETUNE LOGIC
# ============================================================================
...
# Import hyperparams
# H is defined inline above (from hyperparams section)
...
def main(task: str, kfold: int = 0, dataset: str = None):
    ...
    # Load dataset
    data_path = Path("/content/finetuning/datasets") / (dataset or cfg["data_file"])
